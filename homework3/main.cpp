...
int main(int argc, const char** argv)
{
	...
	objl::Loader Loader;
	std::string path = "D:\\VC Programs\\Projects\\games101\\homework3";
	std::string obj_path = path + "\\models\\spot\\";

	// Load .obj File
	bool loadout = Loader.LoadFile(path + "\\models\\spot\\spot_triangulated_good.obj");
